...
//		setSize(283, 500);
	...
	// {{DECLARE_CONTROLS
	public javax.swing.JRadioButton JRadioButton_Gold = new javax.swing.JRadioButton();
	public javax.swing.JRadioButton JRadioButton_Silver = new javax.swing.JRadioButton();
	public javax.swing.JRadioButton JRadioButton_Bronze = new javax.swing.JRadioButton();
	...
	class SymMouse extends java.awt.event.MouseAdapter {
		public void mouseClicked(java.awt.event.MouseEvent event) {
			...
			if (object == JRadioButton_Gold)
				(new AddPAccController(parentframe)).JRadioButtonGold_mouseClicked(event);
			else if (object == JRadioButton_Silver)
				(new AddPAccController(parentframe)).JRadioButtonSilver_mouseClicked(event);
			else if (object == JRadioButton_Bronze)
				(new AddPAccController(parentframe)).JRadioButtonBronze_mouseClicked(event);
		}
	}
	...
	class SymAction implements java.awt.event.ActionListener {
		public void actionPerformed(java.awt.event.ActionEvent event) {
			...
			if (object == JButton_OK)
				...
				(new AddPAccController(parentframe)).JButtonCalcel_actionPerformed(event);
		}
	}
