...
import banking.gui.controllers.AddCompController;
import banking.gui.controllers.AddPAccController;
import banking.gui.view.JDialog_AddPAcc.SymAction;
import banking.gui.view.JDialog_AddPAcc.SymMouse;

public class JDialog_AddCompAcc extends javax.swing.JDialog {
	public final String customerType = "company";
	private JDialog_AddCompAcc parentframe;
	public String accountnr, clientName, street, city, zip, state, accountType, email;
	...
	// {{DECLARE_CONTROLS
	public javax.swing.JRadioButton JRadioButton_Chk = new javax.swing.JRadioButton("Checking");
	public javax.swing.JRadioButton JRadioButton_Sav = new javax.swing.JRadioButton("Saving");
	...
	class SymMouse extends java.awt.event.MouseAdapter {
		public void mouseClicked(java.awt.event.MouseEvent event) {
			...
			if (object == JRadioButton_Chk)
				(new AddCompController(parentframe)).JRadioButtonChk_mouseClicked(event);
			else if (object == JRadioButton_Sav)
				(new AddCompController(parentframe)).JRadioButtonSav_mouseClicked(event);
		}
	}
	class SymAction implements java.awt.event.ActionListener {
		public void actionPerformed(java.awt.event.ActionEvent event) {
			...
			if (JTextField_NoOfEmp.getText().equals(""))
				parentframe.noOfEmployees = Integer.valueOf("0");
			else
				parentframe.noOfEmployees = Integer.valueOf(JTextField_NoOfEmp.getText());

			Object object = event.getSource();
			if (object == JButton_OK)
				(new AddCompController(parentframe)).JButtonOK_actionPerformed(event);
			else if (object == JButton_Calcel)
				(new AddCompController(parentframe)).JButtonCalcel_actionPerformed(event);
		}
	}
